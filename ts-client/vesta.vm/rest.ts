...
/**
 * @title vesta/vm/contracts.proto
...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
   ...
   * @request GET:/vesta/vm/contracts
   */
  queryContractsAll = (
    query?: {
    ...
    this.request<VmQueryAllContractsResponse, RpcStatus>({
      path: `/vesta/vm/contracts`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
   ...
   * @tags Query
   * @name QueryContracts
   * @summary Queries a Contracts by id.
   * @request GET:/vesta/vm/contracts/{id}
   */
